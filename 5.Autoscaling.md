...
# AutoScaling:
```
1. Autoscaling automatically adds or removes EC2 instances based on demand so your application
   stays available, performant and cost efficient.
2. Autoscaling monitors and automatically adjusts the capacity to maintain steady performance
  at the lowest price.
