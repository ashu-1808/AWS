...
You cannot block anyone but you can customize or add IP address which can access
 ...
 3.My IP : Only owner
```
![image alt]([https://github.com/Ashu-1808/AWS-cloud-computing-for-devops/blob/f85cd1edf27a69f85e9e437c398329cb10ab0558/traffic.png](https://github.com/ashu-1808/AWS/blob/f85cd1edf27a69f85e9e437c398329cb10ab0558/traffic.png))
## SSH (Secure Shell)
 ```
